...
INSERT INTO items VALUES ('CHKSD', 'Chicken Salad', 2.85, str_to_date('5-JUN-00', '%d-%M-%Y'));
INSERT INTO items VALUES ('FRTSD', 'Fruit Salad', 3.45, str_to_date('6-JUN-00', '%d-%M-%Y'));
INSERT INTO items VALUES ('GDNSD', 'Garden Salad', 0.99, str_to_date('3-FEB-01', '%d-%M-%Y'));
INSERT INTO items VALUES ('MILSD', 'Millennium Salad', NULL, str_to_date('16-AUG-02', '%d-%M-%Y'));
INSERT INTO items VALUES ('SODA', 'Soda', 0.99, str_to_date('2-FEB-02', '%d-%M-%Y'));
INSERT INTO items VALUES ('WATER', 'Water', 0, str_to_date('20-FEB-01', '%d-%M-%Y'));
INSERT INTO items VALUES ('FRPLT', 'Fruit Plate', 3.99, str_to_date('22-NOV-02', '%d-%M-%Y'));
...
INSERT INTO orders VALUES (1,1,'FIRST','FRTSD',3.45, now());
INSERT INTO orders VALUES (1,2,'FIRST','WATER',0.0,now());
INSERT INTO orders VALUES (1,3,'FIRST','WATER',0.0,now());
INSERT INTO orders VALUES (2,1,'FIRST','CHKSD',2.85,now());
INSERT INTO orders VALUES (3,1,'FIRST','SODA ',0.99,now());
INSERT INTO orders VALUES (3,2,'FIRST','FRPLT',3.99,now());
INSERT INTO orders VALUES (3,3,'FIRST','VGNET',4.38,now());
INSERT INTO orders VALUES (1,1,'#2STR','CKSDS',3.68,now());
INSERT INTO orders VALUES (1,2,'#2STR','CHKSD',2.85,now());
INSERT INTO orders VALUES (1,3,'#2STR','SODA ',0.99,now());
INSERT INTO orders VALUES (1,4,'#2STR','GDNSD',0.99,now());
INSERT INTO orders VALUES (2,1,'#2STR','CHKSD',2.85,now());
INSERT INTO orders VALUES (2,2,'#2STR','SODA ',0.99,now());
INSERT INTO orders VALUES (3,1,'#2STR','CHKSD',2.85,now());
INSERT INTO orders VALUES (3,2,'#2STR','FRPLT',3.99,now());
INSERT INTO orders VALUES (3,3,'#2STR','GDNSD',0.99,now());
INSERT INTO orders VALUES (1,1,'NDSTR','WATER',0.0,now());
INSERT INTO orders VALUES (1,2,'NDSTR','FRPLT',3.99,now());
INSERT INTO orders VALUES (2,1,'NDSTR','GDNSD',0.99,now());
INSERT INTO orders VALUES (3,1,'NDSTR','VGNET',4.38,now());
INSERT INTO orders VALUES (3,2,'NDSTR','FRPLT',3.99,now());
INSERT INTO orders VALUES (3,3,'NDSTR','FRTSD',3.45,now());
INSERT INTO orders VALUES (3,4,'NDSTR','SODA ',0.99,now());
INSERT INTO orders VALUES (1,1,'CASTR','CHKSD',2.85,now());
INSERT INTO orders VALUES (1,2,'CASTR','GDNSD',0.99,now());
INSERT INTO orders VALUES (2,1,'CASTR','SODA ',0.99,now());
INSERT INTO orders VALUES (2,2,'CASTR','FRTSD',3.45,now());
INSERT INTO orders VALUES (2,3,'CASTR','SODA ',0.99,now());
INSERT INTO orders VALUES (2,4,'CASTR','VGNET',4.38,now());
INSERT INTO orders VALUES (3,1,'CASTR','VGNET',4.38,now());
INSERT INTO orders VALUES (3,2,'CASTR','FRPLT',3.99,now());
INSERT INTO orders VALUES (3,3,'CASTR','FRTSD',3.45,now());
INSERT INTO orders VALUES (3,4,'CASTR','WATER',0.0,now());
INSERT INTO orders VALUES (3,5,'CASTR','CHKSD',2.85,now());
